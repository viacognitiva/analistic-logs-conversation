    ...
    var cloudant = {
        ...
        //  console.dir(req);
          ...
          // var dataNow = new Date().toISOString().replace(/T/, ' ').replace(/\..+/, '');
           db.insert({aplicacao:req.body.aplicacao, conversation_id: req.body.conversation_id, messageWatson: req.body.messageWatson,messageUser:req.body.messageUser,intencao:req.body.intencao, data : req.body.data}, 'doc_'+req.body.conversation_id+'_'+new Date().getTime(), function(err, body, header) {
              if (err) {
